...
namespace ImageLib
{
	public class ImageHandler
	{
		...
		public void SetColorFilter2(Bitmap ImageObject, Color InputColor)
		{
			Color color = Color.Black; //Your desired color

			byte r = color.R; //For Red color

			Bitmap bmp = new Bitmap(ImageObject);
